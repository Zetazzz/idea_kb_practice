...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        //  then try run the debug by ctrl+shift+r and stop by cmd+f2
        //  then we are done. Good Job.
        home: new MyHomePage(title: "A Counter",));
  }
}
